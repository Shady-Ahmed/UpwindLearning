...
if training == 'true': 
    ...
    #model.add(LSTM(80, input_shape=(lookback, features.shape[1]+3*npt-8), return_sequences=True, activation='tanh'))
...
plt.savefig('./Plots/Sod_LPP_npt='+str(npt)+'.png', dpi = 500, bbox_inches = 'tight')
plt.show()
